...
%of time is a year)
gamma=0.5;  %this means that there is a low willingness to subs c over time
delta=0.06;
alpha=0.3;
beta=0.95;
ell=1;      %normalization
...
subplot(2,4,1)
sgtitle('Alpha Shock; A = Abar+0.01 = 0.3854; gamma=0.5');
plot(transitspan,ktransit,'b--','LineWidth',lwidnum)
...
saveas(transition_new,"q_2_5_2.png")
saveas(transition_new,"/Users/veronica/Dropbox/Apps/Overleaf/Macro_EC_702_PS_cd0814_jayinliu_vcperez/figures/PS_5_q_2_5_2.png")
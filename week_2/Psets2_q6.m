...
%time objects
T = 101;        %end of time %V review: why 101
...
% generate random eta_i for the countries
eta =normrnd(0,0.5,[100,1])
n_eta = exp(eta)
...
% for point6 we have A0 that varies by country

A0 = n_eta ;                              % normalization 
% ask hannah why this order works. 
...
writematrix(y_pc, "ps2_q6_simulated_data.csv");
